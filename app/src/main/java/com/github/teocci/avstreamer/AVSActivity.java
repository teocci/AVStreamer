package com.github.teocci.avstreamer;
...
public class AVSActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_avs);
    ...
    private void setting() {
        ...
        AlertDialog dialog =  new AlertDialog.Builder(AVSActivity.this)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Toast.makeText(AVSActivity.this, "New address: " + remoteIP + ":" + remoteVideoPort + "|" + remoteAudioPort, Toast.LENGTH_LONG).show();
                    }
                })
