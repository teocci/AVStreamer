...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback
{
    ...
    private void saveYUV(byte[] byteArray)
    {
        ...
        YuvImage im = new YuvImage(byteArray, ImageFormat.NV21, previewSize.width, previewSize
                .height, null);
        ...
        try {
            FileOutputStream output = new FileOutputStream(Environment
                    .getExternalStorageDirectory() + "/yuv.jpg");
    ...
    {
        try {
            FileOutputStream file = new FileOutputStream(new File(Environment
                    .getExternalStorageDirectory() + "/test.yuv"));
            try {
